<%@ Page Title="" Language="C#" MasterPageFile="~/configuration.Master" AutoEventWireup="true" CodeBehind="Seeuse.aspx.cs" Inherits="CentroBiologiaMolecularUCA.Views.Opc.Use.Seeuse" %>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal" runat="server">
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <asp:DropDownList ID="Mrol"  Enabled="false"  runat="server" ToolTip="Rol del usuario" CssClass="form-control">
