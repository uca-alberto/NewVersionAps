<%@ Page Title="" Language="C#" MasterPageFile="~/configuration.Master" AutoEventWireup="true" CodeBehind="AgregarEmpleado.aspx.cs" Inherits="CentroBiologiaMolecularUCA.Views.OpcionesConfigurables.Emp.AgregarEmpleado" %>
    ...
    <script>
     ...
     <!--script de alerta-->
      ...
      <div class="card-header">
        <strong class="card-title">Nuevo Empleado</strong>
         </div>  
