    ...
    <div class="card">                       
      ...
      <div class="card-header">
           ...
           <!--imagen-->                            
                ...
                <div class="col-12 col-md-9">&nbsp;
                <asp:Image ID="Mimagen" runat="server" TextMode="multiline" Columns="50" Rows="5" ToolTip="observaciones" CssClass="form-control" placeholder="Ingrese las observaciones"></asp:Image>
